# 👋 Hi, I'm André Costa Freitas

🎯 **Jr Information Security Analyst | Cybersecurity Enthusiast**

I'm passionate about technology and information security. I specialize in security analysis, fraud prevention, and malware research, always focused on continuous learning and delivering practical solutions. Currently, I'm studying for the **CompTIA PenTest+** certification and finishing my degree in **Information Security**.
...
- 🛠 **Tools & Technologies:** Metasploit, Burp Suite, Wireshark, VMware, Kali Linux, Parrot OS, Nmap, Cisco, GitHub, GitLab, JIRA

---

## 💡 Skills

- **Cybersecurity:** Vulnerability assessment, penetration testing, incident response, Blue Team operations, and threat detection  
- **Malware Analysis:** Research and analysis of malware samples and threat intelligence  
- **Fraud Prevention:** Monitoring, detection, and mitigation of fraudulent activities  
- **Virtualization:** Managing VMware virtual environments for security labs and testing  
- **Network Security:** Configuring and securing networks, including firewalls and VPNs
...
- Oracle Next Education (ONE) – Back-End Development Track
...
The content and repositories shared here are for **educational and professional purposes only**. I do not endorse or support any misuse of the information or tools provided.
